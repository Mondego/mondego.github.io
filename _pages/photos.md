...
<a href="{{ site.url }}{{ site.baseurl }}/images/path/{{ pic.image }}" class="with-caption image-link" title="{{ pic.title }}"><img  src="{{ site.url }}{{ site.baseurl }}/images/path/{{ pic.image }}" class="img-responsive" width="95%" style="float: left" /></a>
</div>
